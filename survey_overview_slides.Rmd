...
ggplot(tmp, aes(x=Var1,y=Freq)) + geom_bar(stat="identity", width=0.5, fill = "blue") + theme_classic() + coord_flip()
...
ggplot(tmp, aes(x=Var1, y=Freq)) + geom_bar(stat="identity", width=0.5, fill = "blue") + coord_flip() + theme_classic()
```
...
* First do some more manual curation of the course list
* Create a report on our website
* Create a database of all the courses on our website
  - Question: Can we maintain such a database long term?
